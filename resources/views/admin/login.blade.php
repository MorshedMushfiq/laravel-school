          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                ...
                @endif
                <form action="{{route('student.login.user')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="mb-3">
                  ...
                  <div class="d-flex align-items-center justify-content-center">
                    ...
                    <a class="text-primary fw-bold ms-2" href="{{route('student.register')}}">Create an account</a>
                  </div>
                </form>
              </div>
            </div>
