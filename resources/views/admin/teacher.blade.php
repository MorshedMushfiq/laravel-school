            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card mt-5">
                <div class="card-body">
                  ...
                  <a href="{{route('teacher.trash.page')}}" class='btn btn-info'>Trash Page</a>
                    ...
                    <table class="table table-striped table-borderless">
                      ...
                      <tbody>
                        ...
                        @endphp
                          ...
                          <td>
                            @if($teacher->user_status=="active")
                            <a href="{{URL::to('/ad-dashboard/teachers/block', $teacher->id)}}" class='btn btn-danger btn-sm'>Block</a>
                            @else
                            <a href="{{URL::to('/ad-dashboard/teachers/active', $teacher->id)}}" class='btn btn-warning btn-sm'>Unblock</a>
                            @endif
                            <a href="{{route('trash.teacher', $teacher->id)}}" class='btn btn-danger btn-sm'>Trash</a>
                            </td>
                        </tr>
                        @endforeach
                      </tbody>
